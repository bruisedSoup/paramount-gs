        ...
        <div
            ...
            <div
                ...
                <div style={{
                    ...
                    <ShoppingBag size={26} color='#0066cc' />
                </div>
                ...
                <p style={{ color: '#6e6e73', fontSize: '14px', lineHeight: '1.6', marginBottom: '24px' }}>
                    Sign in to your account to add items to your cart and start shopping at{' '}
                    <span style={{ color: '#0066cc', fontWeight: '700' }}>Paramount Gadgets</span>.
                </p>
