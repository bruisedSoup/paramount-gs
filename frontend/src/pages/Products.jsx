                ...
                >
                    {items.map((item, index) => (
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0, transition: { duration: 0.4, delay: 0.08 * index, ease: 'easeOut' } }}
                            style={{ flexShrink: 0 }}
                        >
                            {item}
                        </motion.div>
        ...
        <>
                ...
                {open && (
                    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, overflowY: 'auto' }}>
                        ...
                        >
                            ...
                            {/* Product image hero */}
                            <div style={{ background: '#f5f5f7', height: '280px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <img
                                    src={imageUrl}
                                    alt={product.name}
                                    style={{ maxHeight: '240px', maxWidth: '100%', objectFit: 'contain', padding: '20px' }}
                                />
                            </div>

                            {/* Product info */}
                            <div style={{ padding: '24px 28px 32px' }}>
                                <p style={{ fontSize: '13px', color: '#6e6e73', fontWeight: '500', marginBottom: '6px', textTransform: 'capitalize' }}>
                                    {product.category}
                                </p>
                                ...
                                {!isOutOfStock && (
                                    <p style={{ fontSize: '12px', color: '#6e6e73', marginTop: '12px' }}>
            ...
            >
                ...
                <div style={{
                    ...
                    background: 'linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, transparent 45%, rgba(0,0,0,0.7) 100%)',
                    pointerEvents: 'none',
                }} />
                ...
                {isOutOfStock && (
                    <div style={{
                        ...
                        borderRadius: '980px', letterSpacing: '0.02em',
                    }}>
                        Sold Out
                    </div>
                )}
                                ...
                                {latestAccessories.length > 0 && (
                                    <CarouselSection
                                        ...
                                        items={[
                                            ...
                                            />,
                                            ...latestAccessories.map((p, i) => (
                                                <AppleProductCard key={p.id} product={p} index={i + 1} />
                                            ))
                                        ]}
                                    />
                                )}
